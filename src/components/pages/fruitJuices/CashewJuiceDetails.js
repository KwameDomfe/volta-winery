...
function CashewJuiceDetails() {
    const relatedProducts = [
        {   id:'1',
            name:'country cashew juice'
        },
         {   id:'2',
            name:'urban cashew juice'
        },
         {   id:'3',
            name:'elite cashew juice'
        },
    ]
    ...
    return (
        ...
        >
            ...
            >
                Volta Winery || Cashew Juice Details
            </footer>
        </article>
...
export default CashewJuiceDetails;


function JuiceDetailCard(params) {
    return (
